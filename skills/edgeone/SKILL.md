...
在引用具体数值、API 参数或配置选项前，先通过检索获取**最新信息**。
...
当 reference 文件与官方文档不一致时，**以官方文档为准**。尤其注意：数值限制、API 参数签名、配置选项。

## 通用工作流

无论执行哪类任务，**都必须通过调用 API 的方式完成**，首次调用 API 前需完成环境检查：
